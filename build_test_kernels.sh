...
echo ""
echo "Test with:"
echo "  ./bin/be300 --kernel vmlinux-test1-omagic   --cmdline 'console=tty0 earlyprintk keep_bootcon' --speed 0"
echo "  ./bin/be300 --kernel vmlinux-test2-multipage --cmdline 'console=tty0 earlyprintk keep_bootcon' --speed 0"
echo "  ./bin/be300 --kernel vmlinux-test3-uclibc    --cmdline 'console=tty0 earlyprintk keep_bootcon' --speed 0"
echo "  ./bin/be300 --kernel vmlinux-test4-nopic     --cmdline 'console=tty0 earlyprintk keep_bootcon' --speed 0"
